...
<body class="fixed-nav sticky-footer bg-white" id="page-top">
  ...
  <div class="content-wrapper">
      ...
      <div class="row justify-content-md-center">
        <a class="nav-link" href="qr_create.php">
        <button type="button" class="btn btn-primary btn-lg btn-block">Create New QR Code</button>
      </a>
      </div>
    ...
    <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
	      ...
	      <!-- Code for reading qr codes here & display them -->
        <?php
